...
##oz =0
##ow =1
# below is all zero except for joint 5 @ -0.75
##pxf = 2.077
##pyf = 0
##pzf = 2.1466
##ox =0
...
##R_Roll = Matrix([[            cos(math.radians(euler[0]))*cos(math.radians(euler[1])), cos(math.radians(euler[0]))*sin(math.radians(euler[1]))*sin(math.radians(euler[2])) - sin(math.radians(euler[0]))*cos(math.radians(euler[2])),       cos(math.radians(euler[0]))*sin(math.radians(euler[1]))*cos(math.radians(euler[2])) + sin(math.radians(euler[0]))*sin(math.radians(euler[2]))],
...
R0_3 = R0_3.evalf(subs={q1: t0, q2: theta1, q3: t2})
